    ...
    public void proceedButtonAction(ActionEvent actionEvent) {
        ...
        try {
            ...
            try{
                ...
                if(fundsAvailability.checkFundsAvailability(connection,adresseeID) == 0){
            ...
            try{
                ...
                if(clientAvailabilty.checkClientAvailability(connection, receiverID) == 0 || receiverID==adresseeID){
            ...
            if(amountOfMoney < fundsAvailability.checkFundsAvailability(connection, adresseeID)){
                flagBalance = true;
            }else{
